        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= site_url('monitoring/verify_mfa'); ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <label for="one_time_password">Masukkan Kode Verifikasi 6-Digit</label>
                            <input type="text" class="form-control" id="one_time_password" name="one_time_password" required autocomplete="off" maxlength="6" pattern="\d{6}" title="Masukkan 6 digit angka">
                        </div>
                        <button type="submit" class="btn btn-primary">Aktifkan & Verifikasi</button>
                        <a href="<?= site_url('monitoring/edit_profil'); ?>" class="btn btn-secondary">Batal</a>
                    </form>
                    </div>
            </div>
        </div>
