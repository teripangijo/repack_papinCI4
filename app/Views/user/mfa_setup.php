...
<?= $this->section('title') ?>
    <?= esc($subtitle ?? 'Setup MFA') ?>
<?= $this->endSection() ?>

<?= $this->section('content') ?>
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800"><?= esc($subtitle) ?></h1>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <!-- Flash messages handled by main layout -->
                    ...
                    <p class="text-center">
                        <code style="font-size: 1.2rem; letter-spacing: 2px; padding: 10px; background-color: #f8f9fa; border-radius: 5px;"><?= esc($secret_key) ?></code>
                    </p>
